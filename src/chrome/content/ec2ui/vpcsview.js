var ec2ui_VpcTreeView = {
    ...
    createVpc : function () {
        ...
        window.openDialog("chrome://flexiefox/content/dialog_create_vpc.xul", null, "chrome,centerscreen,modal", ec2ui_session, retVal);
    ...
    setDhcpOptions : function () {
        ...
        window.openDialog("chrome://flexiefox/content/dialog_associate_dhcp_options.xul", null, "chrome,centerscreen,modal", ec2ui_session, retVal);
