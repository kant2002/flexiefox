var ec2ui_PermissionsTreeView = {
    ...
    viewDetails : function(event) {
        var perm = this.getSelectedPermission();
        if (perm == null) return;
        window.openDialog("chrome://flexiefox/content/dialog_permission_details.xul", null, "chrome,centerscreen,modal", perm);
    },
    ...
    grantPermission : function() {
        ...
        retVal = {ok:null};
        window.openDialog("chrome://flexiefox/content/dialog_new_permission.xul", null, "chrome,centerscreen,modal", group, ec2ui_session, retVal);
